...
use super::{icmpv6_len_error, ipv6_addr_at, Mldv1Query, Mldv1Report};

/// Borrowed MLDv1 Multicast Listener Report message
...
pub struct Mldv1ReportSlice<'a> {
    slice: &'a [u8],
}

impl<'a> Mldv1ReportSlice<'a> {
    /// Decode an MLDv1 report from bytes containing a full ICMPv6 message.
    ...
    /// Multicast address being reported.
    ...
    pub fn to_report(&self) -> Mldv1Report {
        Mldv1Report {
